...
class getReviewsRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ReviewsRepository.php';

        return $container->privates['App\\Repository\\ReviewsRepository'] = new \App\Repository\ReviewsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
